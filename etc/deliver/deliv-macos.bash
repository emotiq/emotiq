...
# basically, this script calls LWM with three arguments '-init -' (to not load the personal init file) '-build' and 'deliver.lisp'
...
exec "${LWPRO}" -init - -build "${DIR}/deliver.lisp"

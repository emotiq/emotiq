...
%As with any BLS signature, each decrypted share is validated against its proof by checking that the pairings match:
%$$  e(Proof_i, P) &= e(\frac{1}{s_i} \, R, P_i)$$

The decrypted share, $Y_i$, is then broadcast to all group members. 
%Decrypted shares can be verified from the pairing relation:
%$$ e(Proof_i, P) = e(U, G_2(share_i))$$
